...
class TestBugzilla:
    ...
    def test__connect_with_api_key(self, __init__):
        ...
        __init__.assert_called_once_with(
            url="https://example.com/bz", api_key="api_key", cookiefile=None, tokenfile=None
        )
    ...
    def test__connect_with_creds(self, __init__):
        ...
        bz = bugs.Bugzilla()
        patch_config = {
            "bodhi_email": "bodhi@example.com",
            "bodhi_password": "bodhi_secret",
        ...
        __init__.assert_called_once_with(
            ...
            user="bodhi@example.com",
            password="bodhi_secret",
            cookiefile=None,
            tokenfile=None,
        )
    ...
    def test__connect_without_creds(self, __init__):
        ...
        __init__.assert_called_once_with(
            url="https://example.com/bz", cookiefile=None, tokenfile=None
        )
    ...
    def test_close_fault(self, error):
        ...
        error.assert_called_once_with(
            ...
            12345,
            410,
            "You must log in before using this part of Red Hat Bugzilla.",
            exc_info=True,
        )
    ...
    def test_close_private_bug(self, info):
        ...
        bz._bz.getbug.side_effect = xmlrpc.client.Fault(
            102,
            (
                "You are not authorized to access bug #1563797. To see this bug, you must first "
                "log into an account with the appropriate permissions."
            ),
        )
        ...
        info.assert_called_once_with("Cannot retrieve private bug #%d.", 1563797)
    ...
    def test_comment_too_long(self, error):
        ...
        error.assert_called_once_with(f"Comment too long for bug #1411188:  {long_comment}")
    ...
    def test_comment_too_many_attempts(self, error):
        ...
        bz = bugs.Bugzilla()
        bz._bz = mock.MagicMock()
        bz._bz.getbug.return_value.addcomment.side_effect = xmlrpc.client.Fault(
        ...
        assert all(
            c[1] == ("A nice message.",) for c in bz._bz.getbug.return_value.addcomment.mock_calls
        )
