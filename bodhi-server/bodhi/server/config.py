...
class BodhiConfig(dict):
    ...
    _defaults = {
        "acl_system": {"value": "dummy", "validator": str},
        "acl_dummy_committer": {"value": None, "validator": _validate_none_or(str)},
        "admin_groups": {
        ...
        "authtkt.secret": {"value": "CHANGEME", "validator": _validate_secret},
        "authtkt.secure": {"value": True, "validator": _validate_bool},
        "authtkt.timeout": {"value": 86400, "validator": int},
        "automatic_updates_blacklist": {
            # List of users to not create automatic updates from
            "value": ["releng"],
            "validator": _generate_list_validator(),
        },
        "base_address": {"value": "https://admin.fedoraproject.org/updates/", "validator": str},
        "bodhi_email": {"value": "updates@fedoraproject.org", "validator": str},
        "bodhi_password": {"value": None, "validator": _validate_none_or(str)},
        "buglink": {"value": "https://bugzilla.redhat.com/show_bug.cgi?id=%s", "validator": str},
        "bugtracker": {"value": None, "validator": _validate_none_or(str)},
        "bugzilla_api_key": {"value": None, "validator": _validate_none_or(str)},
        "buildroot_limit": {"value": 31, "validator": int},
        "buildsystem": {"value": "dev", "validator": str},
        "bz_exclude_rels": {"value": [], "validator": _generate_list_validator(",")},
        "bz_products": {
        ...
        "bz_server": {"value": "https://bugzilla.redhat.com/xmlrpc.cgi", "validator": str},
        "bz_server_rest": {"value": "https://bugzilla.redhat.com/rest/", "validator": str},
        "cache_dir": {"value": None, "validator": _validate_none_or(validate_path)},
        "celery_config": {"value": "/etc/bodhi/celeryconfig.py", "validator": str},
        "check_signed_builds_delay": {"value": 2, "validator": int},
        "clean_old_composes": {"value": True, "validator": _validate_bool},
        ...
        "cors_origins_ro": {"value": "*", "validator": str},
        "cors_origins_rw": {"value": "https://bodhi.fedoraproject.org", "validator": str},
        "createrepo_c_config": {"value": "/etc/bodhi/createrepo_c.ini", "validator": str},
        "critpath_pkgs": {"value": [], "validator": _generate_list_validator()},
        ...
        "dogpile.cache.backend": {"value": "dogpile.cache.dbm", "validator": str},
        "dogpile.cache.expiration_time": {"value": 100, "validator": int},
        "exclude_mail": {"value": [], "validator": _generate_list_validator()},
        "file_url": {
            "value": "https://download.fedoraproject.org/pub/fedora/linux/updates",
            "validator": str,
        },
        "fmn_url": {"value": "https://apps.fedoraproject.org/notifications/", "validator": str},
        "homepage_stats_num_users": {"value": 10, "validator": int},
        "important_groups": {
            # Defined in and tied to the Fedora Account System (limited to 16 characters)
            "value": [
                "proventesters",
        ...
        "initial_bug_msg": {
            "value": (
                "{update_alias} ({update_beauty_title}) has been submitted as "
        ...
        "greenwave_batch_size": {"value": 8, "validator": int},
        "waiverdb_api_url": {
            "value": "https://waiverdb-web-waiverdb.app.os.fedoraproject.org/api/v1.0",
            "validator": _validate_rstripped_str,
        },
        "waiverdb.access_token": {"value": None, "validator": _validate_none_or(str)},
        "koji_web_url": {
            "value": "https://koji.fedoraproject.org/koji/",
            "validator": _validate_tls_url,
        },
        "koji_hub": {"value": "https://koji.stg.fedoraproject.org/kojihub", "validator": str},
        "krb_ccache": {"value": None, "validator": _validate_none_or(str)},
        "krb_keytab": {"value": None, "validator": _validate_none_or(str)},
        "krb_principal": {"value": None, "validator": _validate_none_or(str)},
        "legal_link": {"value": "", "validator": str},
        "libravatar_dns": {"value": False, "validator": _validate_bool},
        "libravatar_enabled": {"value": True, "validator": _validate_bool},
        "libravatar_prefer_tls": {"value": True, "validator": bool},
        "mail.templates_basepath": {"value": "bodhi.server:email/templates/", "validator": str},
        "mako.directories": {"value": "bodhi.server:templates", "validator": str},
        "min_karma": {
        ...
        "qa_groups": {"value": ["fedora-ci-users"], "validator": _generate_list_validator()},
        "compose_dir": {"value": None, "validator": _validate_none_or(str)},
        "compose_stage_dir": {"value": None, "validator": _validate_none_or(str)},
        "max_concurrent_composes": {"value": 2, "validator": int},
        "message_id_email_domain": {"value": "admin.fedoraproject.org", "validator": str},
        ...
        "openid.provider": {"value": "https://id.fedoraproject.org/openid/", "validator": str},
        "openid.sreg_required": {"value": "email nickname", "validator": str},
        "openid.success_callback": {
            "value": "bodhi.server.auth.utils:remember_me",
            "validator": str,
        },
        "openid.url": {"value": "https://id.fedoraproject.org/", "validator": str},
        "openid_template": {"value": "{username}.id.fedoraproject.org", "validator": str},
        "oidc.fedora.client_id": {"value": "", "validator": str},
        "oidc.fedora.client_secret": {"value": "", "validator": str},
        ...
        "pagure_flatpak_main_branch": {"value": "stable", "validator": str},
        "pagure_module_main_branch": {"value": "master", "validator": str},
        "pagure_url": {
            "value": "https://src.fedoraproject.org/pagure/",
            "validator": _validate_tls_url,
        },
        "privacy_link": {"value": "", "validator": str},
        "pungi.basepath": {"value": "/etc/bodhi", "validator": str},
        "pungi.cmd": {"value": "/usr/bin/pungi-koji", "validator": str},
        "pungi.conf.module": {"value": "pungi.module.conf", "validator": str},
        "pungi.conf.rpm": {"value": "pungi.rpm.conf", "validator": str},
        "pungi.extracmdline": {"value": [], "validator": _generate_list_validator()},
        "pungi.labeltype": {"value": "Update", "validator": str},
        "query_wiki_test_cases": {"value": False, "validator": _validate_bool},
        "release_team_address": {"value": "bodhiadmin-members@fedoraproject.org", "validator": str},
        "session.secret": {"value": "CHANGEME", "validator": _validate_secret},
        "skopeo.cmd": {
        ...
        "smtp_server": {"value": None, "validator": _validate_none_or(str)},
        "sqlalchemy.url": {"value": "postgresql://localhost/bodhi", "validator": str},
        "sqlalchemy_extra.statement_timeout": {"value": 30000, "validator": int},
        "stable_bug_msg": {
            "value": (
                "{update_alias} ({update_beauty_title}) has been pushed to "
                "the {repo} repository.\n"
        ...
        "system_users": {"value": ["bodhi"], "validator": _generate_list_validator()},
        "test_case_base_url": {"value": "https://fedoraproject.org/wiki/", "validator": str},
        ...
        "top_testers_timeframe": {"value": 7, "validator": int},
        "test_gating.required": {"value": False, "validator": _validate_bool},
        "test_gating.url": {"value": "", "validator": str},
        "trusted_build_sources": {"value": [], "validator": _generate_list_validator()},
        "update_notes_maxlength": {"value": 10000, "validator": int},
        "updateinfo_rights": {
            "value": f"Copyright (C) {datetime.now().year} Red Hat, Inc. and others.",
            "validator": str,
        },
        "wait_for_repo_sig": {"value": False, "validator": _validate_bool},
        "warm_cache_on_start": {"value": True, "validator": _validate_bool},
        "wiki_url": {"value": "https://fedoraproject.org/w/api.php", "validator": str},
        "wiki_user_agent": {"value": "FedoraLinuxBodhi-User-Agent", "validator": str},
    }
